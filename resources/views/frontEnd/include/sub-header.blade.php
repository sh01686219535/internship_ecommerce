        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-2 col-md-3 col-4">
                    <div class="logo">
                        <a href="{{route('/')}}"><img src="{{asset('frontEndAsset')}}/assets/img/logo/logo.png" alt=""></a>
                    </div>
                </div>
                        ...
                        <div class="main_menu">
                            <nav>
                                <ul>
                                    ...
                                    <li ><a href="{{route('/')}}">Home <i class="fa fa-angle-down"></i></a>
                                        <ul class="sub_menu">
                                            <li><a href="index-9.html">Home 9</a></li>
                                        </ul>
                                    </li>
                                    <li class="active"><a href="{{route('shop')}}">shop <i class="fa fa-angle-down"></i></a>
                                        <ul class="mega_menu">
                                    ...
                                    <li><a href="#">pages <i class="fa fa-angle-down"></i></a>
                                        <ul class="sub_menu pages">
                                            ...
                                            <li><a href="{{route('loginRegister')}}">login</a></li>
                                            <li><a href="{{route('wishlist')}}l">Wishlist</a></li>
                                            <li><a href="404.html">Error 404</a></li>
