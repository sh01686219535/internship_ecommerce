    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5 text-center" id="exampleModalLabel">Add Brand</h1>
            ...
            <div class="modal-body">
                <form action="{{route('add-brand')}}" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" class="form-control my-3" id="BrandName" name="brand_name" placeholder="Brand Name">
